...
ALTER TABLE PAYMENT
  ADD CONSTRAINT PAYMENT_PK PRIMARY KEY (IDPAYMENT, WORKER_CODE) ENABLE;
...
BEGIN
    IF :NEW.STATUS_ID = 2 AND :OLD.STATUS_ID = 1 THEN
        SELECT COUNT(*) INTO v_detail_exists
         ...
         WHERE PD.IDCOLLECT = :NEW.IDCOLLECT;
...
BEGIN
    ...
    SELECT C.AMOUNT_TO_PAY INTO v_amount
      FROM COLLECT C
     WHERE C.IDCOLLECT = :NEW.IDCOLLECT;
    
    :NEW.AMOUNT_TO_PAY := v_amount;
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RAISE_APPLICATION_ERROR(-20056,
            'No se encontró la recolecta con IDCOLLECT=' || :NEW.IDCOLLECT);
END;
/
...
INSERT INTO PAYMENT (IDPAYMENT, WORKER_CODE, IDPAYMENTDETAIL, DATEPAYMENT)
VALUES (NULL, 'W00001', 1, DATE '2024-06-10');

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 2, 0);

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 3, 0);

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 4, 0);

UPDATE COLLECT 
   SET STATUS_ID = 2
 WHERE IDCOLLECT IN (2, 3, 4);
...
INSERT INTO PAYMENT (IDPAYMENT, WORKER_CODE, IDPAYMENTDETAIL, DATEPAYMENT)
VALUES (NULL, 'W00001', 4, DATE '2024-06-17');

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 5, 0);

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 6, 0);

UPDATE COLLECT 
   SET STATUS_ID = 2
 WHERE IDCOLLECT IN (5, 6);
...
INSERT INTO PAYMENT (IDPAYMENT, WORKER_CODE, IDPAYMENTDETAIL, DATEPAYMENT)
VALUES (NULL, 'W00002', 6, DATE '2025-01-10');

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 8, 0);

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 9, 0);

UPDATE COLLECT 
   SET STATUS_ID = 2
 WHERE IDCOLLECT IN (8, 9);
...
INSERT INTO PAYMENT (IDPAYMENT, WORKER_CODE, IDPAYMENTDETAIL, DATEPAYMENT)
VALUES (NULL, 'W00003', 8, DATE '2024-06-08');

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 11, 0);

INSERT INTO PAYMENTDETAIL (IDPAYMENTDETAIL, IDPAYMENT, IDCOLLECT, AMOUNT_TO_PAY)
VALUES (NULL, PAYMENT_SEQ.CURRVAL, 12, 0);

UPDATE COLLECT 
   SET STATUS_ID = 2
 WHERE IDCOLLECT IN (11, 12);
