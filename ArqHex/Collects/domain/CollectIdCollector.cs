...
{
    public class CollectIdCollector
    {
        public long collectIdCollector { get; }

        public CollectIdCollector(long _collectCollectorIdValue)
        {
            ValidateFormat(_collectCollectorIdValue);
            this.collectIdCollector = _collectCollectorIdValue;
        }
        ...
        {
            if (obj is CollectIdCollector other)
            {
                return collectIdCollector == other.collectIdCollector;
            }
            return false;
        }
        ...
        {
            return collectIdCollector.GetHashCode();
        }

        public override string ToString()
        {
            return collectIdCollector.ToString();
        }

        // Método para acceder al valor
        public long GetValue()
        {
            return collectIdCollector;
        }
